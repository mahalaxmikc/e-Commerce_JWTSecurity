...
public class OrderControllerTest {
    ...
    public void setup(){
        ...
        when(userRepository.findByUsername("laxmi")).thenReturn(user);
    ...
    public void verify_submit(){
        ...
        ResponseEntity<UserOrder> response = orderController.submit("laxmi");
    ...
    public void verify_getOrdersForUser(){
        ...
        ResponseEntity<List<UserOrder>> response = orderController.getOrdersForUser("laxmi");
        assertNotNull(response);
        assertEquals(200, response.getStatusCodeValue());
